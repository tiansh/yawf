...
GM_addStyle(util.str.fill((util.str.cmt(function () { /*!CSS
  ...
  {{yawf-icon-font}}
  // 缩小搜索框为漏斗提供空间
  .WB_global_nav .gn_search_v2 { width: 245px; }
  .WB_global_nav .gn_search_v2 .placeholder, .WB_global_nav .gn_search_v2 .W_input { width: 202px; }
  .gn_topmenulist_search { width: 247px; }
  .WB_global_nav_us .gn_search_v2 { width: 185px; }
  .WB_global_nav_us .gn_search_v2 .placeholder, .WB_global_nav .gn_search_v2 .W_input { width: 142px; }
  .WB_global_nav_us .gn_topmenulist_search { width: 170px; }
  @media screen and (min-width:1295px) {
    .WB_global_nav .gn_search_v2 { width: 505px; }
    .WB_global_nav .gn_search_v2 .placeholder, .WB_global_nav .gn_search_v2 .W_input { width: 462px; }
    .gn_topmenulist_search { width: 507px; }
    .WB_global_nav_us .gn_search_v2 { width: 185px; }
    .WB_global_nav_us .gn_search_v2 .placeholder, .WB_global_nav .gn_search_v2 .W_input { width: 142px; }
    .WB_global_nav_us .gn_topmenulist_search { width: 170px; }
  }
  @media screen and (max-width:1006px) {
    .WB_global_nav .gn_search_v2 { width: 115px; } 
    .WB_global_nav .gn_search_v2 .placeholder, .WB_global_nav .gn_search_v2 .W_input { width: 72px; } 
    .gn_topmenulist_search { width: 117px; }
    .WB_global_nav_us .gn_search_v2 { width: 85px; }
    .WB_global_nav_us .gn_search_v2 .placeholder, .WB_global_nav .gn_search_v2 .W_input { width: 42px; }
    .WB_global_nav_us .gn_topmenulist_search { width: 70px; }
  }
  .gn_topmenulist_search, .WB_global_nav_us .gn_topmenulist_search { min-width: 200px; }
  // 设置框相关样式

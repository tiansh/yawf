...
var text = {
  ...
  'weiboLargeFont': { 'zh-cn': '增大微博正文字号为|原大小的{{<ratio>}}', 'zh-hk': '增大微博正文字型大小為|原大小的{{<ratio>}}', 'zh-tw': '', 'en': 'Increase font size of Weibo content to | {{<ratio>}}' },
...
(function () {
  ...
  item('Member', 5, '.W_icon[class*="icon_member"], .ico_member_dis, [class^="ico_vip"], .W_icon[class*="ico_member"] { display: none !important; }');
  ...
  item('Suishoupai', 146, '.suishoupai2014, .icon_suishoupai2014 { display: none !important; }');
...
filter.items.tool.sidebar.fixed_left = filter.item({
  ...
  'ainit': function () {
    ...
    util.css.add(util.str.cmt(function () { /*!CSS 
      .WB_main_r[yawf-fixed] .WB_main_l { position: fixed; top: 65px !important; overflow: hidden; height: auto !important; width: 150px; }
...
filter.items.tool.sidebar.chose_side = filter.item({
  ...
  'ainit': function () {
    ...
    observer.dom.add(function () {
      if (side === 'left') {
        var b = document.querySelector('#plc_main>.WB_frame_c:first-child+.WB_frame_b:last-child'); if (!b) return;
        var p = b.parentNode;
        p.insertBefore(b, p.firstChild);
      } else if (side === 'right') {
        var c = document.querySelector('#plc_main>.WB_frame_b:first-child+.WB_frame_c:last-child'); if (!c) return;
        var p = c.parentNode;
        var b; for (b = p.firstChild; b.nodeType === Node.TEXT_NODE; b = b.nextSibling);
        p.appendChild(b);
      }
    });
  },
...
filter.items.tool.stylish.no_weibo_space = filter.item({
  ...
  'ainit': function () {
    util.css.add(util.str.cmt(function () { /*!CSS
      ...
      // 新微博加载提示
      .WB_feed [node-type="feed_list_timeTip"] { display: block; height: 30px; margin-bottom: -30px !important; position: relative; top: -15px; line-height: 30px; background: transparent !important; text-align: center; }

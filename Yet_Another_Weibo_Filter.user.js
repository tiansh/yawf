...
(function () {
  ...
  item('Main', 5, '.gn_nav_list>li:nth-child(1) { visibility: hidden !important; }');
  item('Hot', 5, '.gn_nav_list>li:nth-child(2) { visibility: hidden !important; }');
  item('Game', 5, '.gn_nav_list>li:nth-child(3) { visibility: hidden !important; }');
